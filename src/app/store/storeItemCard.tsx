  ...
  return (
    <div className="group flex h-60 w-[150px] flex-col items-center justify-between rounded-[4rem] border-2 border-orange-200 bg-[#feefd8] py-5 hover:cursor-pointer hover:border-orange-500 md:h-80 md:w-60">
      ...
      <button
        ...
        className="flex h-[2.4rem] w-[6rem] items-center justify-between rounded-2xl border bg-amber-300 px-4 font-parkdahyun hover:border-orange-500 md:h-[2.8rem] md:w-[8rem] md:px-6 md:text-xl"
      >
        <span>₩</span>
