...
const SolveProblem = () => {
  return (
    <div className="flex h-full w-full flex-col px-[6rem] py-[8rem]">
      <div className="flex h-[50%] w-full px-[0.5rem]">
        ...
        <div className="flex h-full w-[75%] px-[3rem] py-[3rem]">
          <div className="grid h-full w-full grid-flow-col justify-start gap-x-[3rem] overflow-x-scroll py-[0.3rem] scrollbar-hide">
            ...
            <CategoryGridContents title="자료구조와 알고리즘" count={152} />
          </div>
        </div>
      </div>
      <div className="flex h-[50%] w-full px-[0.5rem]">
        <div className="flex h-full w-[75%] px-[3rem] py-[3rem]">
          <div className="trans grid h-full w-full grid-flow-col justify-end gap-x-[3rem] overflow-x-scroll py-[0.3rem] scrollbar-hide">
...
const CategoryGridContents = ({
  ...
  return (
    <Link
      className="relative flex h-full w-fit text-[2.5vh]"
